        ...
        <nav className="fixed top-0 w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 z-50 transition-colors duration-300">
          <div className="max-w-5xl mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              <a href="/" className="text-xl font-bold text-black dark:text-white transition-colors">HEY SAMIR</a>
    ...
    <div className="max-w-5xl mx-auto py-12">
      <div className="max-w-2xl">
        <ParallaxSection offset={20}>
          <h1 className="text-5xl font-normal mb-8 text-black dark:text-white transition-colors">Hey - I'm Samir.</h1>
        </ParallaxSection>

        <ParallaxSection offset={30}>
          <p className="text-xl mb-6 text-black dark:text-white transition-colors">
            I drive business impact at fintechs.
          </p>
        </ParallaxSection>

        <ParallaxSection offset={40}>
          <p className="text-lg mb-6 leading-relaxed text-black dark:text-white transition-colors">
        ...
        <ParallaxSection offset={50}>
          <p className="text-lg text-black dark:text-white transition-colors">
...
function Portfolio() {
  return (
    <div className="max-w-5xl mx-auto py-12">
      <ParallaxSection offset={20}>
        <h2 className="text-3xl font-bold mb-8 text-black dark:text-white transition-colors">Portfolio</h2>
      </ParallaxSection>
...
function NotFound() {
  return (
    <div className="max-w-5xl mx-auto py-12">
      <h1 className="text-2xl font-bold text-black dark:text-white transition-colors">404 - Page Not Found</h1>
    </div>
  );
}
