      ...
      <header className="px-4 py-6 border-b">
        <nav className="max-w-4xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-6">
            <button onClick={() => setCurrentPage('profile')} className="hover:text-gray-600">PROFILE</button>
            <button onClick={() => setCurrentPage('portfolio')} className="hover:text-gray-600">PORTFOLIO</button>
