          ...
          {isLoading ? (
            <>
              {[...Array(6)].map((_, i) => (
                ...
                >
                  <div className="aspect-[3/2] bg-gray-100 rounded-lg p-8">
            ...
            filteredCompanies.map((company) => (
              ...
              >
                <motion.a 
                  ...
                  className="block p-8 bg-white border border-gray-200 rounded-lg transition-all duration-300 h-full hover:border-[#482a83]/20"
                  whileHover={{ 
                    y: -4,
