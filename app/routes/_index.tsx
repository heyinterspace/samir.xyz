          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button 
                ...
                asChild
              >
                <Link to="/ventures">Our Ventures</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 text-center">
              <Button variant="default" className="bg-indigo-700 hover:bg-indigo-800" asChild>
                <Link to="/portfolio">View All Investments</Link>
              </Button>
            </div>
          </div>
        </div>
