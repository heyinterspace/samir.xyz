 ...
 * @param {any} defaultValue The default value to return if the operation fails
...
export function isAppReady(): boolean {
  return safelyExecute(() => {
    ...
    // For Remix, look for #remix-app or #root
    const appRoot = document.getElementById('remix-app') || document.getElementById('root');
