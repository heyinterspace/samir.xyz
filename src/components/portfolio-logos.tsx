...
export default function PortfolioLogos() {
  ...
  return (
    <div className="w-full">
      {/* Category Filters */}
      <div className="flex flex-wrap gap-4 mb-8 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Added max-w-4xl and adjusted padding */}
        {categories.map(cat => (
          <button
            key={cat}
      ...
      {/* Company Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Added max-w-4xl and adjusted padding */}
        {companies
