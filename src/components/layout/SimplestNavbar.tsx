...
export default function SimplestNavbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-screen h-20 bg-[#5239cc] dark:bg-[#5239cc] flex justify-center items-center z-[1000] shadow-md !important">
      ...
      <div className="max-w-[1200px] w-full h-full flex justify-between items-center px-6">
        ...
        <div className="flex items-center justify-start flex-shrink-0">
          <Link href="/" className="flex items-center no-underline">
            ...
            <div className="bg-gradient-to-br from-[#4285f4] to-[#8c5ad7] w-12 h-12 flex items-center justify-center rounded-md mr-4 shadow-md">
              <span className="!text-white dark:!text-white text-2xl font-bold font-alexandria">S</span>
            </div>
            <span className="!text-white dark:!text-white text-2xl font-medium font-alexandria">samir.xyz</span>
          </Link>
        </div>
        ...
        <nav className="flex items-center justify-end gap-8 flex-nowrap flex-shrink-0 ml-auto">
          <Link 
            href="/profile/"
            className={`!text-white dark:!text-white text-base uppercase tracking-wider font-alexandria no-underline hover:opacity-90 pb-1 ${
