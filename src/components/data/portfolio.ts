...
export const companies: Company[] = [
  ...
  { name: 'The Food Company', logo: '/portfolio-logos/The Food Company.png', category: 'Retail', description: 'Innovative food products and sustainable packaging solutions.' },
