...
export const companies: Company[] = [
  ...
  { name: 'Swansea City AFC', logo: '/portfolio-logos/SwanseaCityAFC.png', category: 'Retail', description: 'Professional football club competing in the English Football League Championship.' },
  ...
  { name: 'The Coffee', logo: '/portfolio-logos/TheCoffee.png', category: 'Retail', markup: true, description: 'Premium coffee brand focused on quality beans and innovative brewing methods.' },
